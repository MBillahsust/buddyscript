            ...
            <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
              ...
              <li className="nav-item _header_nav_item">
                <span
                  ...
                  onClick={() => { setNotifyOpen(o => !o); setProfileOpen(false) }}
                >
                  ...
                  <div className={`_notification_dropdown${notifyOpen ? " show" : ""}`} id="_notify_drop">
                        ...
                        {[1, 2, 3, 4].map((i) => (
                          <div className="_notification_box" key={i}>
                            <div className="_notification_image">
                              <img src={i % 2 === 0 ? "/assets/images/profile-1.png" : "/assets/images/friend-req.png"} alt="" className="_notify_img" />
                            </div>
                            <div className="_notification_txt">
                              <p className="_notification_para">
                                <span className="_notify_txt_link">{i % 2 === 0 ? "Admin" : "Steve Jobs"}</span>
                                {i % 2 === 0 ? " changed the group name." : " posted a link in your timeline."}
                              </p>
            ...
            <div className="_header_nav_profile">
              ...
              <div className="_header_nav_dropdown">
                ...
                <button
                  ...
                  type="button"
                  onClick={() => { setProfileOpen(o => !o); setNotifyOpen(false) }}
                >
              ...
              <div className={`_nav_profile_dropdown _profile_dropdown${profileOpen ? " show" : ""}`}>
                <div className="_nav_profile_dropdown_info">
                  <div className="_nav_profile_dropdown_image">
                    <img src={session?.user?.image ?? "/assets/images/profile.png"} alt="Profile" className="_nav_drop_img" />
                  </div>
